...
<head>
    ...
    <title>ProyectoY | SaaS Dashboard</title>
...
<?php else: ?>
    ...
    <div class="main-content">
        <header class="topbar">
            <div class="topbar-left">
                <span class="app-title">Welcome</span>
            </div>
        </header>
        <section class="dashboard-section" style="text-align:center;">
            <h2>Welcome to ProyectoY</h2>
            <p>Your modern SaaS dashboard starter. Please log in or register to continue.</p>
